...
// Conflicts — emoji-based icons (centered in viewBox)
const ICON_EXPLOSION = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">💥</text></svg>`);
const ICON_GUNFIRE = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">⚔️</text></svg>`);
const ICON_PROTEST = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">✊</text></svg>`);
const ICON_RIOT = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">🔥</text></svg>`);
const ICON_VIOLENCE = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">🎯</text></svg>`);
const ICON_STRATEGIC = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">📡</text></svg>`);

// Fires & disasters — emoji icons centered
const ICON_FIRE = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">🔥</text></svg>`);
const ICON_WAVE = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">🌊</text></svg>`);
const ICON_EARTHQUAKE = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">🌍</text></svg>`);
const ICON_CYCLONE = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">🌀</text></svg>`);
const ICON_VOLCANO = svgToDataUrl(`<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><text x="24" y="24" text-anchor="middle" dominant-baseline="central" font-size="28">🌋</text></svg>`);
